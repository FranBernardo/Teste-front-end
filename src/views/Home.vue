<template>
  <div class="container">
    <h2>Blog de postagens</h2>
    <p>
      Bem vindo ao nosso blog de postagens, aproveite nossas postagens e se
      divirta.
    </p>
    <p>
    ...
    <div class="container-segundo">
      <h3>O que deseje ver primeiro?</h3>
      <div>
        <div class="container-btn">
          <div class="btn">
            <el-button type="primary" plain
              ><router-link to="/Postagens"
                >Nossas postagens</router-link
              ></el-button
            >
          </div>
          <div class="btn">
            <el-button type="primary" plain
              ><router-link to="/Postagens"
                ><router-link to="/Usuarios">Usuarios</router-link></router-link
              ></el-button
            >
          </div>
        </div>
